 ...
 */
package ejerciciojarvis;

import entities.Armor;
import entities.Enemy;
import entities.Radar;

import services.ArmorSerivces;
...
//donde JARVIS susurra cosas al oído de Tony. Cada dispositivo de la armadura de 
//Iron Man (botas, guantes, consola y sintetizador) tienen un consumo de energía asociado.
//
...
//¿Qué ocurre si cuando llevo 8 enemigos aumeSnto la capacidad del vector?
...
//JARVIS solo podrá disparar si el dispositivo está sano ya si su nivel de batería lo permite.
//Si tiene los dos guantes sanos podrá disparar con ambos guantes haciendo más daño.
//Resolver utilizando un for each paraa recorrer el arreglo y un while para destruir al enemigo.
//Acciones Evasivas
...
//        EnemyService es = new EnemyService();
        ...
        ArmorSerivces as = new ArmorSerivces();
